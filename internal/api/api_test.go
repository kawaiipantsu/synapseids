...
func newTestServer() http.Handler {
	...
	return New(cfg, bus, store, rt, nil, nil, nil, nil, nil, nil, nil, nil, nil).Handler()
}
...
func TestStatusFlowObjectFromProvider(t *testing.T) {
	...
	h := New(cfg, bus, store, rt, nil, nil, nil, nil, stubFlowStats{want}, nil, nil, nil, nil).Handler()
