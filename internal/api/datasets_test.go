...
func dsServer(t *testing.T) (*Server, string, string) {
	...
	srv := New(cfg, events.New(), st, rt, nil, audit.New(auditDir, quiet),
		dataset.Open(dsDir, st, nil, quiet), nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestDatasetRoutesWithoutAManager(t *testing.T) {
	...
	h := New(cfg, events.New(), storage.NewMem(10, 10), rt, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil).Handler()
